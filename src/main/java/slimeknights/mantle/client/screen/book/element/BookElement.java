...
public abstract class BookElement extends GuiComponent {
  ...
  public abstract void draw(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks, Font fontRenderer, RenderType renderType);
  ...
  public void renderToolTip(PoseStack matrixStack, Font fontRenderer, ItemStack stack, int x, int y) {
    ...
    Font font = fontRenderer;//TODO: get font from stack somehow????
    if (font == null) {
      font = fontRenderer;
    }
